...
INTERRUPT_HANDLER(AWU_IRQHandler, 1)
{
   ...
   */  
   ...
   {         
      extern void AWU_InterruptHandler_cb(void);
      AWU_InterruptHandler_cb();
   }
   #endif
}
...
INTERRUPT_HANDLER(EXTI_PORTA_IRQHandler, 3)
{
   ...
   */
   ...
   {
      extern void Gpio_PORTA_InterruptHandler_cb(void);
      Gpio_PORTA_InterruptHandler_cb();
   }
